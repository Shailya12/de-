...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: 'var(--bg)' }}>
      ...
      {/* Right panel — form */}
      <div className="w-full lg:w-1/2 xl:w-2/5 flex flex-col items-center justify-center px-6 py-10" style={{ background: 'var(--bg)' }}>
        {/* Mobile logo */}
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mt-5 text-center">
            <Link href="/" className="inline-flex items-center gap-1 text-xs transition-colors"
              style={{ color: 'var(--text-3)' }}>
